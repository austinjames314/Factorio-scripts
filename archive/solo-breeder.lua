function on_tick()
    ...
    PumpMatrix = {20, 40} -- Thermal power draw at each stage of pump activation.
    ...
    SteamShutdownLevel = 171600 -- 357 seconds (gives buffer to keep filling with steam while shutting down)
    SteamStartupLevel = 31200 -- 65 seconds 
